...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('utilisateur', '0002_alter_kwgperson_user'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('purpose', models.CharField(choices=[('O', 'Bureau'), ('S', 'Site'), ('H', 'Domicile'), ('D', 'Point de distribution postal'), ('U', "Défini par l'utilisateur")], help_text='Identifies the logical location of the address', max_length=1)),
                ('description', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('roles', models.ManyToManyField(to='utilisateur.kwgActorRole')),
                ('the_organization', models.ManyToManyField(related_name='engages', to='catalogue.kwgOrganization')),
                ('the_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='engaged_in', to='utilisateur.kwgperson')),
            ],
            options={

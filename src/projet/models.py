...
class Projet(models.Model):
	...
	localisation = models.ManyToManyField(GeoRefPostalAddress, related_name="endroits", null=True)
	docz = models.ManyToManyField(Document, related_name="documentation", null=True)
	client = models.ManyToManyField(kwgOrganization, related_name="client", null=True)

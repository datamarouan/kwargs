...
class Projet(models.Model):
	...
	localisation = models.ManyToManyField(GeoRefPostalAddress, related_name="endroits", blank=True)
	docz = models.ManyToManyField(Document, related_name="documentation", blank=True)
	client = models.ManyToManyField(kwgOrganization, related_name="client", blank=True)
...
class Tache(models.Model):
	...
	docz = models.ManyToManyField(Document, related_name="documents_lies", blank=True)
	tags = TaggableManager(verbose_name="Mots-clés", blank=True,
	help_text="Une liste de mots-clés séparés par une virgule, en minuscule")
